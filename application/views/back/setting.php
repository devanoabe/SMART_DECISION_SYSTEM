					...
					<div class="row my-2">
						<div class="col">
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Nama Aplikasi" name="nama_aplikasi" value="<?= $r->nama_aplikasi;?>">
							</div>
							<div class="form-group">
	...
	<div class="col">
		<div class="card border-bottom-primary shadow mb-4">
			...
			<div class="card-body">
				...
				<center>
					<button class="btn btn-sm btn-primary btn-icon-split m-2" id="simp_help">
						<span class="icon text-white"><i class="fas fa-paper-plane"></i></span>
						<span class="text">Simpan</span>
					</button>
					<button type="button" class="btn btn-sm btn-danger btn-icon-split m-2" id="reset_help">
						<span class="icon text-white"><i class="fas fa-eraser"></i></span>
						<span class="text">Reset Halaman Bantuan</span>
					</button>
				</center>
			</div>
		</div>
